package agalfioni.recipesai.ingredientsdetector.presentation.components
    ...
    TopAppBar(
        ...
        title = {
            Box(
                ...
                Text(
                    text = stringResource(R.string.confirm_scanned_ingredients),
...
@Preview
@Composable
private fun IngredientsDetectorToolbarPreview() {
    RecipesAITheme {
