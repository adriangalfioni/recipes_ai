package agalfioni.recipesai.ingredientsdetector.data.datasource
...
class LocalizedIngredientsDataSource(
    ...
    suspend fun loadIngredients(forcedLocale: Locale? = null): List<LocalIngredient> =
