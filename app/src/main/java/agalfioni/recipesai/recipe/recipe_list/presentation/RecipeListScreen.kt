...
import agalfioni.recipesai.recipe.recipe_list.presentation.components.AiProgressSection
import agalfioni.recipesai.recipe.recipe_list.presentation.components.RecipeCard
import agalfioni.recipesai.recipe.recipe_list.presentation.components.RecipeListTopBar
...
fun RecipeListScreen(
    ...
    aiProgressViewModel: agalfioni.recipesai.recipe.recipe_list.presentation.AiProgressViewModel = koinViewModel(),
    recipesListViewModel: agalfioni.recipesai.recipe.recipe_list.presentation.RecipesListViewModel = koinViewModel()
) {
    ...
    _root_ide_package_.agalfioni.recipesai.recipe.recipe_list.presentation.RecipeListScreenRoot(
...
fun RecipeListScreenRoot(
    onBackClick: () -> Unit,
    onNavigateToRecipe: (String) -> Unit,
    aiProgressUiState: agalfioni.recipesai.recipe.recipe_list.presentation.AiProgressState,
    generateRecipesUiState: agalfioni.recipesai.recipe.recipe_list.presentation.GenerateRecipesUiState,
    onEvent: (agalfioni.recipesai.recipe.recipe_list.presentation.RecipeListEvent) -> Unit,
    modifier: Modifier = Modifier,
) {
