package agalfioni.recipesai.recipe.presentation.recipelist.components
...
import agalfioni.recipesai.recipe.presentation.recipelist.previewproviders.RecipeUiProvider
...
fun RecipeCard(
    ...
    val cardContainerColor =
        if (recipeUi.isMatchHigh && showMatchIndicator) {
